        ...
        <div class="panel-body">
            <form action="{{ route('admin.kegiatan.update', ['id' => $kegiatan->id]) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="kode" value="{{ $kegiatan->kode }}" placeholder="Masukkan kode kegiatan..." type="text" required id="kode">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="nama" value="{{ $kegiatan->nama }}" placeholder="Masukkan nama kegiatan..." type="text" required id="nama">
                </div>
                <br>
                <div class="form-group">
