    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            ...
            <div class="text-right">
                <a class="btn btn-success update-pro" href="{{ route('admin.utama.index', ['tabName' => 'organisasi']) }}" title="Kembali"><i class="fa fa-arrow-left"></i> <span> Kembali</span></a>
            </div>
        </div>
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <table class="table project-table text-center"  id="tabel-program">
                    ...
                    <tbody>
                        @foreach($organisasi->program as $program)
