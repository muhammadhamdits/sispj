...
<div class="main">
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            <h3 class="panel-title">Edit Data sub4uraian {{ $sub4uraian->nama }}</h3>
        ...
        <div class="panel-body">
            ...
            @endif
            <form action="{{ route('admin.sub4uraian.update', ['id' => $sub4uraian->id]) }}" method="post">
                @csrf
                @method('PATCH')
                <div class="form-group">
                	 <div class="form-group">
                    <label for="rekening">Kode Rekening : </label>
                    <input class="form-control @error('rekening') is-invalid @enderror" name="rekening" placeholder="Masukkan rekening program..." type="text" value="{{ $sub4uraian->rekening }}" id="rekening">
                    ...
                    <select name="sub3_uraian_id" id="sub3_uraian_id" class="form-control @error('sub3_uraian_id') is-invalid @enderror">
                        @foreach($sub3uraians as $sub3uraian)
                         @if($sub3uraian->id == $sub4uraian->sub3_uraian_id)
                        <option selected value="{{ $sub3uraian->id }}">{{ $sub3uraian->nama }}</option>
                        @else
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Masukkan nama sub4uraian..." type="text" id="nama" value="{{ $sub4uraian->nama }}">
